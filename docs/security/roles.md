...
<!-- To edit the table below, edit RegsitryFeatures.ods, then save it as a csv file and set the delimiter character to | (pipe). May also need to add leading/trailing pipes to format as Markdown table. BUT change checks to YES and blanks to NO for a11y. WCAG 1.3.1 -->

<div tabindex="0" markdown="1">
